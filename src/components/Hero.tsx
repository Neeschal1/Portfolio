    ...
    <section className="relative min-h-screen flex items-center justify-center cosmic-bg overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-6xl mx-auto px-6">
        <div className="space-y-8 animate-fade-in">
          <div>
            <h1 className="text-6xl md:text-8xl font-bold text-gradient mb-2 animate-scale-in font-poppins">
              NEES C HAL
            </h1>
            <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed animate-slide-in-left font-poppins">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-slide-in-right">
            ...
            >
              <Mail className="font-poppins mr-2 h-5 w-5 group-hover:scale-110 transition-transform" />
              Get In Touch
            </Button>
            <Button
              variant="outline"
